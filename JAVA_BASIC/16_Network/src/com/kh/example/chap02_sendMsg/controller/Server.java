...
public class Server {
	...
	// 한 토프에 한 ServerSocket만 연결이 가능

	// Socket
	// 프로세스 간 통신 담당
	// InputStream/OutputStrema 보유 : 이 스트림을 통해 프로세스 간의 통신(입출력)이 이루어짐

	public void serverStart() {
		// 서버용 TCP 소켓 프로그래밍 순서
		// 1). 서버 포트 번호 지정
		// 2). 서버용 소켓 객체 생성 후 포트와 결합
		// 3). 클라이언트한테 요청이 오기를 기다림
		...
		//	BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(output));
			...
			// PrintWriter System.out.println .. 등이 담겨져 있는곳.
